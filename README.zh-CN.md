...
XIA Sandbox 已进入**公开预览**。**引擎构建现已可下载** —— 从 [**Releases**](https://github.com/gary95271/xia-sdk/releases/tag/engine-v0.1.0-preview)
获取，几分钟就能在局域网起一个交互式 Ubuntu 控制台（见 [**快速上手**](#快速上手)）。完整集成文档与
SDK 接口同样已可用。打磨版的即插即用 1.0 SDK 包正在路上；⭐ Star / Watch 跟进发布。
...
> 没装 Node？打包流程会出一个双击即用的 `xia-serve.exe`（免安装）。引擎构建单独提供，见 [Release 资产](https://github.com/gary95271/xia-sdk/releases/tag/engine-v0.1.0-preview)。
...
- [x] **引擎二进制 —— 预览版已可下载**（见 [Releases](https://github.com/gary95271/xia-sdk/releases/tag/engine-v0.1.0-preview)）
- [ ] 打磨版即插即用 1.0 SDK 包
...
**什么时候能用？**
现在，公开预览中 —— **引擎构建已可从 [Releases](https://github.com/gary95271/xia-sdk/releases/tag/engine-v0.1.0-preview) 下载**，本地 demo 运行器和完整文档也已可用（见[快速上手](#快速上手)）。打磨版的即插即用 1.0 SDK 包正在路上；⭐ Star / Watch 跟进。
